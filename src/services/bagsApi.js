...
export const getTokenCreators = (tokenMint) => get('/token-launch/creator/v3', { tokenMint })
...
// Sekarang pakai JSON bukan FormData
export const createTokenInfo = (body) => post('/token-launch/create-token-info', body)
